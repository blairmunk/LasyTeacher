...
DOCUMENT_SECTION_CATALOG = (
    ...
    DocumentSectionCatalogItem(
        ...
        supported_document_types=(EVENT_PERFORMANCE_REPORT_DOCUMENT_TYPE,),
        renderable_document_types=(EVENT_PERFORMANCE_REPORT_DOCUMENT_TYPE,),
        description='Посещаемость, средняя оценка и распределение отметок.',
    ),
    DocumentSectionCatalogItem(
        ...
        supported_document_types=(EVENT_PERFORMANCE_REPORT_DOCUMENT_TYPE,),
        renderable_document_types=(EVENT_PERFORMANCE_REPORT_DOCUMENT_TYPE,),
        description='Ошибки по заданиям и темы, требующие внимания.',
    ),
    DocumentSectionCatalogItem(
        section_type=EVENT_REPORT_CONCLUSIONS_SECTION,
        title='Выводы и дальнейшая работа',
        supported_document_types=(EVENT_PERFORMANCE_REPORT_DOCUMENT_TYPE,),
        renderable_document_types=(EVENT_PERFORMANCE_REPORT_DOCUMENT_TYPE,),
    ...
    DocumentSectionCatalogItem(
        ...
        description='Количество оценок, пропусков и работ, требующих внимания.',
        is_repeatable=True,
    ),
    DocumentSectionCatalogItem(
        section_type=STUDENT_DIGEST_RETAKES_SECTION,
        title='Работы к сдаче или пересдаче',
        supported_document_types=(STUDENT_DIGEST_DOCUMENT_TYPE,),
        renderable_document_types=(STUDENT_DIGEST_DOCUMENT_TYPE,),
        description='Персональный список задолженностей и пересдач.',
        is_repeatable=True,
    ),
    DocumentSectionCatalogItem(
        section_type=STUDENT_DIGEST_DETAILS_SECTION,
        title='Список оценок',
        supported_document_types=(STUDENT_DIGEST_DOCUMENT_TYPE,),
        renderable_document_types=(STUDENT_DIGEST_DOCUMENT_TYPE,),
        description='Оценки и рекомендации по предметам за период.',
        is_repeatable=True,
    ),
    DocumentSectionCatalogItem(
        section_type=STUDENT_DIGEST_FOCUS_SECTION,
