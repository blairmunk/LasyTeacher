...
def content_config_from_document(document: Document) -> dict:
    ...
    task_section = _first_section_payload(document, TASK_VARIANTS_SECTION)
    include_full_solutions = FULL_SOLUTIONS_SECTION in section_types
    ...
    return {
        ...
        'include_hints': task_section.get('include_hints', False),
        'include_instructions': task_section.get('include_instructions', False),
    }


def _first_section_payload(document: Document, section_type: str) -> dict:
